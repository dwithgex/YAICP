...
const { Client, Events, GatewayIntentBits, User, ActivityType } = require('discord.js');
...
class DiscordBot {
  ...
  status: 'online',
            ...
            console.log(`► [✅ Invite Link]: https://discord.com/api/oauth2/authorize?client_id=${process.env.CLIENT_ID}&permissions=&permissions=414464735296&scope=bot`);
            console.log('\x1b[36m', '▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬' ,'\x1b[0m');
        });
